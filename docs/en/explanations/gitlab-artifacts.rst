...
- Presigned downloads require either an existing ``presigned.json`` file or a GitLab pipeline whose child pipeline and publishing job can be discovered from configuration.
